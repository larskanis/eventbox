...
In contrast to internal scope, they should not share any data with other actions or threads.
...
And all data generated by the action should be passed as arguments to internal methods and should be managed there.
...
They mislead the developer to beleave that a module is thread-safe when it's using these classes.
