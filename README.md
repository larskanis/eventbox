...
There is no hard criteria for blocking operations, but since event scope methods don't run concurrently, it decreases the overall responsiveness of the Eventbox instance.
